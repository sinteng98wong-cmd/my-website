  ...
  if (treatments.length === 0) {
    return (
      <div className="card p-10 text-center text-slate-400">
        No treatments recorded for {date}
      </div>
    );
  }
      ...
      <div className="card p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        {signoff ? (
          <div className="flex items-center gap-3">
            <span className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center text-green-600 text-lg">✓</span>
            <div>
          ...
          <div className="flex items-center gap-3">
            <span className="w-8 h-8 rounded-full bg-amber-100 flex items-center justify-center text-amber-600 text-lg">!</span>
            <div>
